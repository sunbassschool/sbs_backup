...
const funnel = "routine_main_droite"
...
useHead({
  title: "Routine main droite basse – stabilité et groove en 20 minutes | SunBassSchool",
  meta: [
    {
      name: "description",
      content:
        "Routine technique de 20 minutes pour développer régularité, attaque et contrôle rythmique de la main droite à la basse."
    }
  ],
  link: [
    {
      rel: "canonical",
      href: "https://www.sunbassschool.com/module-routine-main-droite"
    }
  ]
})
...
Routine main droite :
<span class="accent">
20 minutes pour stabiliser ton groove
</span>
...
Une routine simple pour améliorer la régularité,
l’attaque et le contrôle rythmique de ta main droite.

</p>

<ul class="benefits">

<li>5 exercices progressifs</li>
...
<li>Stabiliser ton attaque</li>
<li>Avoir un sonp plus propre</li>
<li>Développer ta vélocité</li>
<li>Améliorer tes intentions rythmiques</li>
...
<h2>
Pourquoi la main droite perd vite en stabilité ?
</h2>

<p>

La régularité de la main droite est essentielle pour le groove.

Quelques jours sans jouer peuvent suffire à perdre
la sensation d’attaque et de stabilité.

</p>

<p>

Cette routine permet de retrouver rapidement
un geste contrôlé et régulier.
...
<li>Buté doigts isolés</li>
<li>Buté alterné index / majeur</li>
<li>Groupes de trois notes</li>
<li>Variations d’alternance</li>
<li>Isolation du doigt faible</li>
