...
import { logoutUser } from "@/utils/api.ts";  // Assure-toi que le chemin est correct selon ton projet
...
console.log("🔗 Proxy URL utilisée :", proxyURL);
const response = await fetch(proxyURL);
  ...
  try {
    ...
    if (data.message.includes("Mot de passe réinitialisé")) {
